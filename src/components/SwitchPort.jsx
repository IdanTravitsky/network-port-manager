...
const SwitchPort = memo(({ portNum, switchId, connection, maps, onEdit, onAssign, onDisconnect, onNavigateToSwitch, showIp, showUser }) => {
    ...
    }, [connection, maps.wallPorts, maps.users, maps.vlanColors]);
    ...
    return (
        <>
            ...
            {portData.isConnected && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max max-w-xs p-2.5 bg-slate-900 border border-slate-600 rounded-lg shadow-xl z-50 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity text-xs">
